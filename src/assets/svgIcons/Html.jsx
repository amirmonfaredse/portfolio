      ...
      <Chip
        icon={
          <SvgIcon>
            ...
            >
              <style type="text/css">
                {`.st0html{fill-rule:evenodd;clip-rule:evenodd;fill:#E44D26;}
                  .st1html{fill-rule:evenodd;clip-rule:evenodd;fill:#F16529;}
                  .st2html{fill-rule:evenodd;clip-rule:evenodd;fill:#EBEBEB;}
                  .st3html{fill-rule:evenodd;clip-rule:evenodd;fill:#FFFFFF;}
                   `}
              </style>
              <g>
                <polygon
        ...
        color="success"
        label="HTML"
        sx={{ width: 120, color: "secondary.main", px: 2, py: 3, mx: 2 }}
      />
    </>
  );
};
